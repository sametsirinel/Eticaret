<?php 
	...
	class InternalDosya{
		...
		public $ortaWidth = 480;
		
		public $ortaHeight = 270;
		
		public $kucukWidth = 160;
		
		public $kucukHeight = 90;
		...
		public function base64($file){
			...
			preg_match("#data:(.*?);base64,#",$file,$mime);
			...
			$filename = time()."_".rand(0,999).$uzanti;
						
			$this->resimadi = $filename;
			
			if($this->base64_to_jpeg($file,UPLOADS_DIR."$filename")){
