              ...
              <div class="product product--zoom">
                <div class="product__inside">
                  ...
                  <div class="product__inside__image">
                    ...
                    <!-- quick-view -->
                    <a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view get-item-detail" data-url="<?=baseurl("urunler/ajaxDetail/".$urun->seo_link."/".$urun->id) ?>"><b><span class="icon icon-visibility"></span> Quick view</b> </a>
                    <!-- /quick-view -->
                  </div>
                  <!-- /product image -->
                  <!-- product name -->
                  <div class="product__inside__name">
                    <h2><a href="<?=baseurl("detay/".$urun->seo_link."/".$urun->id) ?>">Mauris lacinia lectus</a></h2>
                  </div>
                  ...
                  <div class="product__inside__hover">
                    ...
                    <div class="product__inside__info">
                      ...
                      <a href="<?=baseurl("detay/".$urun->seo_link."/".$urun->id) ?>" class="btn btn--ys btn--xl  row-mode-visible hidden-xs"><span class="icon icon-visibility"></span> Quick view</a> </div>
