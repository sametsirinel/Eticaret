		 ...
		 <div class="container">
			 <div class="row">
				 <div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
					 <!-- logo start -->
					 <a href="index.html"><img class="logo replace-2x img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>logo.png" alt=""/> </a>
					 <!-- logo end -->
				 </div>
									 ...
									 <div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
										 <div class="container">
											 ...
											 <ul>
												 ...
												 <?php if(!empty(Cart::selectItems())){ ?>
													 <?php foreach(Cart::selectItems() as $item){ ?>
														 <li class="cart__item">
															 <div class="cart__item__image pull-left"><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>product/product-1.jpg" alt=""/></a></div>
															 <div class="cart__item__control">
																 <div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Sepetten Sil</span></a></div>
															 </div>
															 <div class="cart__item__info">
																 <div class="cart__item__info__title">
																	 <h2><a href="#"><?=$item["baslik"] ?></a></h2>
																 </div>
											 ...
											 <div class="cart__bottom">
												 ...
												 <a href="#" class="btn btn--ys"><span class="icon icon-shopping_basket"></span> Tümünü Gör</a>
											 </div>
										 </div>
									 </div>
								 </div>
