    ...
    <div class="tp-banner">
      <ul>
        ...
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
          <!-- MAIN IMAGE -->
          <img src="<?=baseurl(UPLOADS_DIR); ?>slides/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" >
          <!-- LAYERS -->
          <!-- TEXT -->
        ...
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
          <!-- MAIN IMAGE -->
          <img src="<?=baseurl(UPLOADS_DIR); ?>slides/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
          <!-- LAYERS -->
          <!-- TEXT -->
        ...
        <!-- SLIDE - 3 -->
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
                <img src="<?=baseurl(UPLOADS_DIR); ?>slides/04/intro_img_03.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
              <!-- LAYER NR. 1 -->
        ...
        <div class="category-carousel">
          <div class="col-sm-4 col-md-4 col-lg-4">
            <a href="listing.html" class="banner zoom-in">
              <span class="figure">
                <img src="<?=baseurl(UPLOADS_DIR); ?>custom/category-3.jpg" alt=""/>
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
            <a href="listing.html" class="banner zoom-in">
            <span class="figure">
              <img src="<?=baseurl(UPLOADS_DIR); ?>custom/category-2.jpg" alt=""/>
              <span class="figcaption">
                <span class="block-table">
                  <span class="block-table-cell">
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
            <a href="listing.html" class="banner zoom-in">
            <span class="figure">
              <img src="<?=baseurl(UPLOADS_DIR); ?>custom/category-1.jpg" alt=""/>
              <span class="figcaption">
                <span class="block-table">
                  <span class="block-table-cell">
    ...
    <div class="container">
      <div class="row">
                ...
                <div class="product__inside">
                  ...
                  <div class="product__inside__image">
                    <a href="<?=baseurl("detay/".$urun->seo_link."/".$urun->id) ?>">
                      <img src="<?php echo baseurl(UPLOADS_DIR).$urun->resmi ?>" alt=""> </a>
                    <!-- quick-view -->
                    <a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view get-item-detail" data-url="<?=baseurl("urunler/ajaxDetail/".$urun->seo_link."/".$urun->id) ?>"><b><span class="icon icon-visibility"></span> Hemen İncele</b> </a>
                    <!-- /quick-view -->
                  </div>
                  <!-- /product image -->
                  <!-- product name -->
                  <div class="product__inside__name">
                    <h2><a href="<?=baseurl("detay/".$urun->seo_link."/".$urun->id) ?>"><?=$urun->adi ?></a></h2>
                  </div>
                  <!-- /product name -->                 <!-- product description -->
                  <!-- visible only in row-view mode -->
                  <div class="product__inside__description row-mode-visible"> <?=$urun->kisaaciklama ?> </div>
                  <!-- /product description -->                 <!-- product price -->
                  <div class="product__inside__price price-box"><?=$urun->min." - ".$urun->max; ?></div>
                  ...
                  <div class="product__inside__review row-mode-visible">
                    ...
                    <a href="#">1 Review(s)</a> <a href="#">Yorumlarını İncele</a>
                  </div>
                  <!-- /product review -->
                  <div class="product__inside__hover">
                    <!-- product info -->
                    <div class="product__inside__info">
                      <div class="product__inside__info__btns"> <a  href="#" data-toggle="modal" data-target="#quickViewModal" data-url="<?=baseurl("urunler/ajaxDetail/".$urun->seo_link."/".$urun->id) ?>" class="btn btn--ys btn--xl  get-item-detail"><span class="icon icon-shopping_basket"></span> Sepete Ekle</a>
                      <a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-favorite_border"></span></a>
                      <a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-sort"></span></a>
                      <a href="<?=baseurl("detay/".$urun->seo_link."/".$urun->id) ?>" class="btn btn--ys btn--xl  row-mode-visible hidden-xs"><span class="icon icon-visibility"></span> Hemen İncele</a> </div>
        ...
        <div class="col-xl-4 visible-xl">
          ...
          <a class="link-img-hover" href="lookbook.html"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/lookbook.jpg" class="img-responsive" alt=""></a>
      ...
      <div class="row">
        <div class="banner-carousel">
          <div class="col-md-4 col-sm-4 col-xs-12">
            <a href="listing.html" class="banner zoom-in">
            <span class="figure">
              <img src="<?=baseurl(UPLOADS_DIR); ?>custom/banner-01.jpg" alt=""/>
              <span class="figcaption">
                <span class="block-table">
                  <span class="block-table-cell">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <a href="listing.html" class="banner zoom-in">
              <span class="figure">
                <img src="<?=baseurl(UPLOADS_DIR); ?>custom/banner-02.jpg" alt=""/>
                <span class="figcaption">
                  <span class="block-table">
                    <span class="block-table-cell">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <a href="listing.html" class="banner zoom-in">
              <span class="figure">
                <img src="<?=baseurl(UPLOADS_DIR); ?>custom/banner-03.jpg" alt=""/>
                <span class="figcaption">
                  <span class="block-table">
                    <span class="block-table-cell">
            ...
            <div class="col-lg-3">
              ...
              <div class="product">
                <div class="product__inside">
                  <!-- product image -->
                  <div class="product__inside__image">
                    <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-9.jpg" alt=""> </a>
                    <!-- quick-view -->
            ...
            <div class="col-lg-3">
              ...
              <div class="product">
                <div class="product__inside">
                  <!-- product image -->
                  <div class="product__inside__image">
                    <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-10.jpg" alt=""> </a>
                    <!-- quick-view -->
                    <a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>
                    <!-- /quick-view -->
                  </div>
                  ...
                  <div class="product__inside__hover">
                    ...
                    <div class="product__inside__info">
                      <ul class="options-swatch options-swatch--color">
                        <li><a href="#"><span class="swatch-label"><img src="<?=baseurl(UPLOADS_DIR); ?>colors/blue.png" width="10" height="10" alt=""/></span></a></li>
                        <li><a href="#"><span class="swatch-label"><img src="<?=baseurl(UPLOADS_DIR); ?>colors/yellow.png" width="10" height="10" alt=""/></span></a></li>
                        <li><a href="#"><span class="swatch-label"><img src="<?=baseurl(UPLOADS_DIR); ?>colors/red.png" width="10" height="10" alt=""/></span></a></li>
                      </ul>
                      <div  class="product__inside__info__btns"> <a href="#" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span> Add to cart</a>
                      <a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-favorite_border"></span></a>
                      <a href="#" class="btn btn--ys btn--xl visible-xs"><span class="icon icon-sort"></span></a>
        ...
        <div class="col-xl-4 visible-xl">
          ...
          <div class="text-center promos">
            ...
            <div class="promos__image">
              ...
              <img src="<?=baseurl(UPLOADS_DIR); ?>custom/promos.jpg" class="img-responsive" alt="">
            ...
            <div class="col-lg-3">
              ...
              <div class="product">
                <div class="product__inside">
                  <!-- product image -->
                  <div class="product__inside__image">
                    <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-11.jpg" alt=""> </a>
                    <!-- quick-view -->
                    <a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>
                    <!-- /quick-view -->
                  </div>
            ...
            <div class="col-lg-3">
              ...
              <div class="product">
                <div class="product__inside">
                  <!-- product image -->
                  <div class="product__inside__image">
                    <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-12.jpg" alt=""> </a>
                    <!-- quick-view -->
                    <a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>
                    <!-- /quick-view -->
                  </div>
        ...
        <div class="slider-blog slick-arrow-bottom">
            ...
            <div class="slider-blog__item">
              <div class="row">
                <div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
                  <img src="<?=baseurl(UPLOADS_DIR); ?>custom/slider-blog-img01.jpg" alt="">
                </div>
          ...
          <a href="blog-post-right-column.html" class="link-hover-block">
            <div class="slider-blog__item">
              <div class="row">
                <div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
                  <img src="<?=baseurl(UPLOADS_DIR); ?>custom/slider-blog-img02.jpg" alt="">
                </div>
          ...
          <a href="blog-post-right-column.html" class="link-hover-block">
            <div class="slider-blog__item">
              <div class="row">
                <div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
                  <img src="<?=baseurl(UPLOADS_DIR); ?>custom/slider-blog-img03.jpg" alt="">
                </div>
                <div class="col-xs-12 col-sm-5 box-data">
              ...
              <div class="recent-post-box">
                <div class="col-lg-12 col-xl-6">
                  <a href="blog-post-right-column.html">
                    <span class="figure">
                      <img src="<?=baseurl(UPLOADS_DIR); ?>custom/recent-posts-01.jpg" alt="">
            ...
            <div class="col-sm-3 col-xl-6">
              ...
              <div class="recent-post-box">
                <div class="col-lg-12 col-xl-6">
                  <a href="blog-post-right-column.html">
                  <span class="figure">
                  <img src="<?=baseurl(UPLOADS_DIR); ?>custom/recent-posts-02.jpg" alt="">
                  <span class="figcaption label-top-left">
                  <span>
                  <b>26</b>
                  <em>jun</em>
            ...
            <div class="col-sm-3 col-xl-6">
              ...
              <div class="recent-post-box">
                <div class="col-lg-12 col-xl-6">
                  <a href="blog-post-right-column.html">
                  <span class="figure">
                  <img src="<?=baseurl(UPLOADS_DIR); ?>custom/recent-posts-03.jpg" alt="">
                  <span class="figcaption label-top-left">
                  <span>
                  <b>26</b>
                  <em>jun</em>
