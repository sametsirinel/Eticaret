<div class="modal-dialog white-modal">
  <div class="modal-content container">
          ...
          <div class="row product-info-outer">
            ...
            <div class="product-info col-xs-12 col-sm-7 col-md-6 col-lg-6">
              ...
              <form class="sepet-form" action="<?=baseurl("sepet/ekle/".$urun->id); ?>" method="post">
                <div class="wrapper">
                    ...
                    <ul class="options-swatch options-swatch--size options-swatch--lg select-attr">
                      <?php foreach($urunOzellikleri as $urunozellik){ ?>
                        <li><a href="Javascript:;" class="" data-id="<?=$urunozellik->id ?>" data-fiyat="<?=$urunozellik->fiyat ?>"><?=$urunozellik->ozellikadi ?></a></li>
                      <?php } ?>
                    </ul>
                ...
                <div class="wrapper">
                  <input type="hidden" name="fiyatid" class="fiyatid" value="0">
                  <div class="pull-left"><span class="qty-label">Miktar:</span></div>
                  <div class="pull-left"><input type="text" name="miktar" class="input--ys qty-input pull-left" value="1"></div>
                  <div class="pull-left"><button type="button" class="btn btn--ys btn--xxl btn-sepet-submit"><span class="icon icon-shopping_basket"></span> Sepete Ekle</button></div>
                </div>
	...
	<script type="text/javascript">
        ...
        if($("input[name=fiyatid]").val()==0){
          alert("Lütfen Ürün Özelliği Seçiniz");
        }else{
  				$(".sepet-form").submit();
        }
        return false;
