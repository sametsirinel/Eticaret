		 ...
		 <ul class="expander-list">
			 <li>
				 <span class="name">
					 ...
					 <a href="<?=baseurl(); ?>"><span class="act-underline">Ansayfa</span></a>
				 </span>
				 <ul class="dropdown-menu megamenu image-links-layout" role="menu">
					 <li class="col-one-fourth">
						 <span class="image-link">
						 <a href="index.html">
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-1.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-2.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-3.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-4.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-5.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-6.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-7.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-8.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-9.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-10.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-11.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/layout-img-12.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
			 ...
			 <li>
				 ...
				 <ul class="dropdown-menu megamenu image-links" role="menu">
					 <li class="col-one-fourth">
						 <span class="image-link">
						 <a href="listing.html">
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-1.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-2.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-3.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-4.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-5.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-6.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-7.png" alt=""/></span>
					 ...
					 <li class="col-one-fourth">
						 ...
						 <span class="figure"><img class="img-responsive img-border" src="<?=baseurl(UPLOADS_DIR); ?>custom/listing-img-8.png" alt=""/></span>
			 ...
			 <li>
				 ...
				 <ul class="dropdown-menu megamenu image-links" role="menu">
					 <li class="col-one-third">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/product-menu-img-1.png" alt=""/></span>
					 ...
					 <li class="col-one-third">
						 <span class="image-link">
						 <a href="product.html">
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/product-menu-img-2.png" alt=""/></span>
					 ...
					 <li class="col-one-third">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/product-menu-img-3.png" alt=""/></span>
			 ...
			 <li>
				 ...
				 <ul class="dropdown-menu megamenu image-links" role="menu">
					 <li class="col-one-third">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/blog-menu-img-1.png" alt=""/></span>
					 ...
					 <li class="col-one-third">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/blog-menu-img-2.png" alt=""/></span>
					 ...
					 <li class="col-one-third">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/blog-menu-img-3.png" alt=""/></span>
			 ...
			 <li>
				 ...
				 <ul class="dropdown-menu megamenu image-links" role="menu">
					 <li class="col-one-fifth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/gallery-menu-img-1.png" alt=""/></span>
					 ...
					 <li class="col-one-fifth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/gallery-menu-img-2.png" alt=""/></span>
					 ...
					 <li class="col-one-fifth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/gallery-menu-img-3.png" alt=""/></span>
					 ...
					 <li class="col-one-fifth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/gallery-menu-img-4.png" alt=""/></span>
					 ...
					 <li class="col-one-fifth">
						 ...
						 <span class="figure"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/gallery-menu-img-5.png" alt=""/></span>
		 ...
		 <div class="container">
			 <div class="row">
				 <div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
					 <!-- logo start -->
					 <a href="<?=baseurl(); ?>"><img class="logo replace-2x img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>logo.png" alt=""/> </a>
					 <!-- logo end -->
				 </div>
							 ...
							 <div class="responsive-menu mainMenu">
								 ...
								 <ul class="nav navbar-nav">
									 ...
									 <li class="dropdown dropdown-mega-menu">
										 <a href="<?=baseurl(); ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Anasayfa</span></a>
										 <ul class="dropdown-menu megamenu image-links-layout" role="menu">
											 <li class="col-one-fourth">
												 <span class="image-link">
												 <a href="index.html">
									 ...
									 <li class="dropdown dropdown-mega-menu">
										 ...
										 <ul class="dropdown-menu megamenu" role="menu">
															 ...
															 <div class="product">
																 <div class="product__inside">
																	 ...
																	 <div class="product__inside__image">
																		 <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-20.jpg" alt=""> </a>
																	 </div>
																	 <!-- /product image -->
																	 <!-- product name -->
														 ...
														 <div>
															 ...
															 <div class="product">
																 <div class="product__inside">
																	 <!-- product image -->
																	 <div class="product__inside__image">
																		 <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-2.jpg" alt=""> </a>
																	 </div>
																	 <!-- /product image -->
																	 <!-- product name -->
																	 <div class="product__inside__name">
														 ...
														 <div>
															 ...
															 <div class="product">
																 <div class="product__inside">
																	 <!-- product image -->
																	 <div class="product__inside__image">
																		 <a href="product.html"> <img src="<?=baseurl(UPLOADS_DIR); ?>product/product-4.jpg" alt=""> </a>
											 ...
											 <li class="col-sm-12 hidden-xs">
												 <div class="row">
													 <div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/banner-megamenu-01.jpg" alt=""/></a> </div>
													 <div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/banner-megamenu-02.jpg" alt=""/></a> </div>
												 </div>
											 </li>
										 </ul>
									 </li>
										 ...
										 <ul class="dropdown-menu megamenu" role="menu">
											 ...
											 <li class="col-sm-3">
												 <a href="listing.html" class="megamenu__subtitle">
													 <span>TOPS</span>
													 <span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/mens-category-1.jpg" alt=""/></span>
												 </a>
											 ...
											 <li class="col-sm-3">
												 <a href="listing.html" class="megamenu__subtitle">
													 <span>BOTTOMS</span>
													 <span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/mens-category-2.jpg" alt=""/></span>
												 </a>
												 <ul class="megamenu__submenu megamenu__submenu--marked">
													 <li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													 <li class="level2"><a href="listing.html">Trousers</a></li>
											 ...
											 <li class="col-sm-3">
												 <a href="#" class="megamenu__subtitle">
													 <span>ACCESSORIES</span>
													 <span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="<?=baseurl(UPLOADS_DIR); ?>custom/mens-category-3.jpg" alt=""/></span>
												 </a>
												 <ul class="megamenu__submenu megamenu__submenu--marked">
													 <li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													 <li class="level2"><a href="listing.html">Bags</a></li>
											 ...
											 <li class="col-sm-3 hidden-xs">
												 ...
												 <div class="vertical-carousel vertical-carousel-1 special-carousel">
													 <div class="vertical-carousel__item">
														 <div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="<?=baseurl(UPLOADS_DIR); ?>product/product-120x150-1.jpg" alt=""></a></div>
													 ...
													 <div class="vertical-carousel__item">
														 <div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="<?=baseurl(UPLOADS_DIR); ?>product/product-120x150-2.jpg" alt=""></a></div>
														 <div class="product__label product__label--sale"> <span>Sale</span></div>
														 <div class="vertical-carousel__item__title">
											 ...
											 <li class="col-sm-12 hidden-xs">
												 ...
												 <ul class="list-inline brands-list">
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-01.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-03.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-02.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-05.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-04.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-06.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-07.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-08.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-09.png" alt=""></a></li>
													 <li><a href="#"><img src="<?=baseurl(UPLOADS_DIR); ?>custom/brand-10.png" alt=""></a></li>
												 </ul>
											 </li>
										 </ul>
									 </li>
						 ...
						 <div class="text-right">
							 ...
							 <div class="account link-inline">
								 <div class="dropdown text-right">
									 ...
									 <ul class="dropdown-menu dropdown-menu--xs-full">
										 <li><a href="<?=baseurl("profil"); ?>"><span class="icon icon-person"></span>Hesabım</a></li>
										 <li><a href="<?=baseurl("profil/favoriler");?>"><span class="icon icon-favorite_border"></span>Favorilerim</a></li>
										 <li><a href="<?=baseurl("profil/siparisler");?>"><span class="icon icon-done_all"></span>Siparişlerim</a></li>
										 <li><a href="<?=baseurl("cikis"); ?>"><span class="icon icon-person_add"></span>Çıkış Yap</a></li>
										 <li class="dropdown-menu__close"><a href="#"><span class="icon icon-close"></span>close</a></li>
									 </ul>
								 </div>
							 </div>
							 ...
							 <?php }else{ ?>
								 <div class="account link-inline">
								 	<a class="btn btn-default btn-sm" style="margin-top:-20px;" href="<?=baseurl("giris")?>">Giriş Yap</a>
								 </div>
								 <div class="account link-inline">
								 	<a class="btn btn-default btn-sm" style="margin-top:-20px;" href="<?=baseurl("kayit")?>">Kayıt Ol</a>
								 </div>
							 <?php } ?>
							 ...
							 <div class="cart link-inline">
								 <div class="dropdown text-right">
									 ...
									 <?php if(Cart::totalItems()!=0) : ?>
										 <span class="badge badge--cart"><?=Cart::totalItems(); ?></span>
									 <?php endif ?>
									 </a>

									 <div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
										 <div class="container">
											 <div class="cart__top">Sepetinizde <?=Cart::totalItems(); ?> adet ürün bulunmakta</div>
											 ...
											 <ul>
												 ...
												 <?php if(!empty(Cart::selectItems())){ ?>
													 <?php foreach(Cart::selectItems() as $item){ ?>
														 <li class="cart__item">
															 <div class="cart__item__image pull-left"><a href="<?=baseurl("detay/{$item["seo_link"]}/{$item["id"]}"); ?>"><img src="<?=baseurl(UPLOADS_DIR).$item["resmi"]; ?>" alt=""/></a></div>
															 <div class="cart__item__control">
																 <div class="cart__item__delete"><a href="<?=baseurl("sepet/cikar/".$item["name"]); ?>" class="icon icon-delete"><span>Sepetten Sil</span></a></div>
															 </div>
															 <div class="cart__item__info">
																 <div class="cart__item__info__title">
																	 <h2><a href="<?=baseurl("detay/{$item["seo_link"]}/{$item["id"]}"); ?>"><?=$item["baslik"] ?></a></h2>
																 </div>
	       												<input type="hidden" name="id[]" value="<?=$item["name"] ?>">
																 <div class="cart__item__info__price"><span class="info-label">Fiyat :  </span><span><?=$item["price"] ?></span></div>
																 <div class="cart__item__info__qty"><span class="info-label">Miktar : </span><input type="text" name="adet[]"  class="input--ys" value='<?=$item["quantity"] ?>' /></div>
																 <div class="cart__item__info__details">
																	 <div class='multitooltip'>
																		 <a href="#"><?=$item["kisaaciklama"] ?></a>
											 ...
											 <div class="cart__bottom">
												 <div class="cart__total">Toplam Miktar: <span> <?=Cart::totalPrices(); ?> </span> <i class="fa fa-try"></i></div>
												 <a href="<?=baseurl() ?>" class="btn btn--ys btn-checkout">Tamamla <span class="icon icon--flippedX icon-reply"></span></a>
												 <a href="<?=baseurl("sepet") ?>" class="btn btn--ys"><span class="icon icon-shopping_basket"></span> Tümünü Gör</a>
												 <a href="<?=baseurl("sepet") ?>" class="btn btn--ys"><span class="icon icon-shopping_basket"></span> Sepeti Güncelle</a>
											 </div>
										 </div>
									 </div>
								 </div>
 ...
 <!-- End HEADER section -->
				...
				<div class="row" >
					<div class="col-sm-12 col-md-5 col-lg-6 border-sep-right">
						<div class="footer-logo hidden-xs">
							<!--  Logo  -->
							<a class="logo" href="index.html"> <img class="replace-2x" src="<?=baseurl(UPLOADS_DIR); ?>logo.png"  alt="YOURStore"> </a>
							<!-- /Logo -->
						</div>
						<div class="box-about">
	...
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/jquery/jquery-2.1.4.min.js"></script>

	<script src="<?=baseurl(SCRIPTS_DIR); ?>jquery.js"></script>
	<!-- Bootstrap 3-->
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/bootstrap/bootstrap.min.js"></script>
	<!-- Specific Page External Plugins -->
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/slick/slick.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/bootstrap-select/bootstrap-select.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/countdown/jquery.plugin.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/countdown/jquery.countdown.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/instafeed/instafeed.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/magnific-popup/jquery.magnific-popup.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/isotope/isotope.pkgd.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/imagesloaded/imagesloaded.pkgd.min.js"></script>
	<script src="<?=baseurl(RESOURCES_DIR); ?>external/colorbox/jquery.colorbox-min.js"></script>
	<!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
	<script type="text/javascript" src="<?=baseurl(RESOURCES_DIR); ?>external/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
	<script type="text/javascript" src="<?=baseurl(RESOURCES_DIR); ?>external/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
	<script type="text/javascript" src="<?=baseurl(RESOURCES_DIR); ?>external/elevatezoom/jquery.elevatezoom.js"></script>
	<!-- Custom -->
	<script src="<?=baseurl(SCRIPTS_DIR); ?>custom.js"></script>
	<script src="<?=baseurl(SCRIPTS_DIR); ?>js-index-01.js"></script>
		<script src="<?=baseurl(SCRIPTS_DIR); ?>js-product.js"></script>
	<script type="text/javascript">

		$(function(){

			$(".get-item-detail").click(function(){
