                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" action="<?php echo baseurl("panel/".Uri::segment(1)."/doInsert") ?>" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Alan Adı Giniz</label>

                                    <div class="col-sm-10"><input type="text" name="alanyetkisi" class="form-control"></div>
                                </div>
